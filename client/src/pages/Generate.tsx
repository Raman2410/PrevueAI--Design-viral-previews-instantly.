                        ...
                        <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                          <div>
                            ...
                            <div className="space-y-5">
                                  ...
                                  {/* AspectRatioSelector */}
                                   <AspectRatioSelector value={aspectRatio} onChange={(value) => setAspectRatio(value)} />
                                  {/* StyleSelector */}
                                  <StyleSelector value={style} onChange={(value) => setStyle(value)} isOpen={styleDropdownOpen} setIsOpen={setStyleDropdownOpen} />
                                  {/* ColorSchemaSelector */}
                                  <ColorSchemeSelector value={colorSchemeId} onChange={(value) => setColorSchemeId(value)} />
                                  {/* Details */}
                                  <div className="space-y-2">
